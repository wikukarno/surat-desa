                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="card card-primary">
                                <div class="card-body">
                                        <form action="{{ route('lurah.ubah-foto') }}" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            ...
                                            <div class="text-center thumbnail-image" onclick="updateImage()">
                                                ...
                                                <input type="file" name="foto_profile" id="update-image-lurah" style="display: none" onchange="form.submit()">
