...
<section class="section-top" style="margin: 30px; margin-top: -30px" style="text-align: justify">
	<div style="text-align: center;">
		...
		<p style="margin-top: -10px">Nomor : 503/UM/2022</p>
	</div>
        ...
        <tbody>
            ...
            <tr>
                <td style="line-height: 24px">
                    Kecamatan Pangkalan Kuras dan menurut sepengetahuan kami ianya benar mempunyai Usaha menjahit pakaian jadi <b>"KEBUN KELAPA SAWIT, DAN JASA TRANSPORTASI"</b> di Kelurahan Sorek Satu.
                </td>
            </tr>
        </tbody>
    </table>
